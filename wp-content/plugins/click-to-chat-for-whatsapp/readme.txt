...
8 Styles + Add your own Image/GIF.

Styles are customizable, configure to match website theme.

[list of Styles](https://holithemes.com/plugins/click-to-chat/list-of-styles/)

= Position to Place = 

* Add styles at any position of the screen (not limited to fixed positions)  

* Display the icon for any number of times on pages using shortcodes  

= Pre-filled Message =

Pre-filled message is a text that appears on the WhatsApp chat window when the user clicks on Image/button. User can start the conversation easily. 

To add Web page URL, Title in Pre-filled message add {{url}}, {{title}} placeholders

with these placeholders we can understand from which page the user started WhatsApp chat.
 
[pre-filled message](https://holithemes.com/plugins/click-to-chat/pre-filled-message/)

= Show/Hide = 

'Show or Hide' based on Post type, Post ID, Category, Device Type(Mobile, Dekstop).

= Change Values at page level =

Can change 'WhatsApp Number', 'Call to Action' at page level

[page level settings](https://holithemes.com/plugins/click-to-chat/change-values-at-page-level/)

= Analytics =

Creates an Event when user clicks on WhatsApp Icon/button.
...
Add styles with inline content

For shortcodes we can change the WhatsApp Number, Style, Pre-filled message, Call to Action.
...
Enable Group fetaure from plugins settings page. 

After Enable, Add WhatsApp Group ID, And let your website vistiors join to WhatsApp Group easily.

[Group](https://holithemes.com/plugins/click-to-chat/group-chat-feature/)

== Share ==

Enable your customers to share your web page with their Contacts
...
Plugin won't collect your users data and do not use cookies.
...
or
[chat with us](http://api.whatsapp.com/send?phone=919494429789&text=Hi%20HoliThemes,%20I%20have%20a%20question:)
